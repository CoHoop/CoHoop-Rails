...
class UserProfilePresenter < ApplicationPresenter
  ...
  # Public: displays the avatar in an image tag as a thumbnail
  #
  # Returns an HTML String.
  def avatar
  ...
  # Public: displays the avatar and an avatar upload form if the user has the right rights
  #
  # Returns an HTML String.
  def manage_avatar
    if can_edit?
  ...
  # Public: displays an avatar upload form if the user has the right rights
  #
  # Returns an HTML String.
  def avatar_form
    if can_edit?
